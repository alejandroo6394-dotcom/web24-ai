...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-r from-brand-violet to-brand-cyan text-white shadow-glow hover:shadow-[0_0_70px_-10px_rgba(124,92,255,0.6)] hover:-translate-y-0.5",
        secondary:
          "glass text-foreground hover:bg-white/5 hover:-translate-y-0.5",
        outline:
          "border border-border bg-transparent text-foreground hover:bg-white/5 hover:border-white/20",
        ghost: "text-foreground/80 hover:text-foreground hover:bg-white/5",
        white: "bg-white text-neutral-950 hover:bg-white/90 hover:-translate-y-0.5",
      },
      size: {
        sm: "h-9 px-4",
        md: "h-11 px-6",
